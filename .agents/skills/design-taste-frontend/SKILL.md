...
This project is plan2go. For any file under src/app/t/, src/features/, or src/ui/,
DESIGN.md at the repo root is the dominant source of truth and overrides every rule
below it. The rules below govern the marketing page and the share view only. Where
they conflict with DESIGN.md, DESIGN.md wins. Ignore the hero discipline rules and the
marketing-page ban list inside the app shell.
