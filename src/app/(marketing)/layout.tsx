...
/**
 * The public face of the site: everything a person sees before they have a trip.
 * It owns the page shell and the footer, so a second marketing page inherits both
